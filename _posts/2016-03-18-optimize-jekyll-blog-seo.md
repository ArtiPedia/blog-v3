...
desc: Jekyll SEO (Search Engine Optimization) is something I struggled hard to figure out since I moved from WordPress. Initially,it was hard but gradually I found out that we can do a lot of things using liquid syntax. I have discussed some of the must do optimization to rank higher on search engines.
keywords: 
author: sharathdt
tags: SEO Jekyll
