...
Above liquid syntax will find all the theme files inside **_themes** folder and list them out along with their title and description. I have also included images in my theme collection using ``{% raw %}{{page.image}}{% endraw %}``. For simplicity, I haven't included it here. This will render a theme list like this.
